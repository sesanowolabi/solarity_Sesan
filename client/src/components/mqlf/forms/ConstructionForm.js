...
class ConstructionForm extends Component {
  ...
  handleSubmit(event){
    ...
    if (validate === true) {
      ...
      mixpanel.track('Construction Form - Website', {
  ...
  render() {
    ...
    return (
      ...
      <FormSubmitModal modalIsOpen={this.state.modalIsOpen} closeModal={this.closeModal} successTag={this.props.successTag}/>
        ...
        <form id="constructionForm" className="grey1">
          ...
          <div className={"col-6 inline-block " + ((this.state.input7) ? "input-group invalid" : "input-group")}>
            ...
            <input onBlur={this.addPartialLead} onChange={this.handleChangeLand} aria-label="textbox"/>
          ...
          <div className={"col-6 inline-block " + ((this.state.input9) ? "input-group invalid" : "input-group")}>
            ...
            <input onBlur={this.addPartialLead} type="number" max="999999999" aria-label="down payment" onChange={this.handleChangeDownPayment}/>
