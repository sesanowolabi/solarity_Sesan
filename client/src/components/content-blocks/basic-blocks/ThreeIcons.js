...
const ThreeIcons = props => {
  const data = props.data;
  console.log(data);
  console.log("we are in the three icon block");

  return (
    <section className="full-width stripe_9 " >
      <div className="container--md three-col-flex clearfix three-icon-block ">
        <div className="col mb-4 pr-2 text-center ">

          <img className="borderradius--small force-align-center " src={`${process.env.REACT_APP_S3_URL}` + data.icon1[0].filename} alt={data.icon1[0].title}/>
        ...
        <div className="col mb-4 pl-2 pr-2 text-center ">

          <img className="borderradius--small force-align-center " src={`${process.env.REACT_APP_S3_URL}` + data.icon2[0].filename} alt={data.icon2[0].title}/>
        ...
        <div className="col mb-4 pl-2 text-center ">

          <img className="borderradius--small force-align-center" src={`${process.env.REACT_APP_S3_URL}` + data.icon3[0].filename} alt={data.icon3[0].title}/>
