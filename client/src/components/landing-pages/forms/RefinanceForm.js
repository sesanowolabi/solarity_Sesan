...
class RefinanceForm extends Component {
  ...
  handleSubmit(event){
    ...
    if (validate === true) {
      ...
      mixpanel.track('Refinance Form - LP', {
        form: 'Refinance Form - LP',
  ...
  render() {
    ...
    return (
    	 <div >
       {
        ...
        <form id="refinanceForm" className="grey1 inner_3" onSubmit={this.handleSubmit}>
          ...
          <div className={(this.state.input7) ? "input-group invalid" : "input-group"}>
           ...
           <select onBlur={this.addPartialLead} className="select mb-1" aria-label="home usage" ref={(homeUseSelect) => { this.homeUseSelect = homeUseSelect; }} onChange={() => this.handleChangeHomeUsage()}>
             <option value='none'>Choose</option>
          ...
          <div className={(this.state.input8) ? "input-group invalid" : "input-group"}>
            ...
            <select onBlur={this.addPartialLead} className="select mb-1" aria-label="is this a cash out refinance" ref={(extraCashSelect) => { this.extraCashSelect = extraCashSelect; }} onChange={() => this.handleChangeAdditionalCash()}>
             <option value='none'>Choose</option>
          ...
          <div className={(this.state.input9) ? "input-group invalid mb-1" : "input-group mb-1"}>
            ...
            <input onBlur={this.addPartialLead} className="" onChange={this.handleChangeLand} aria-label="address of house"/>
          ...
          <div className={(this.state.input10) ? "input-group invalid mb-1" : "input-group mb-1"}>
