...
class PurchaseForm extends Component {
  ...
  addPartialLead(){
    ...
    const formData = {
       "loanQuizHomeType": this.state.loanType,
  ...
  handleSubmit(event){
    ...
    if (validate === true) {
      ...
      //   if(res) {
      //    console.log(res);
      //    console.log('a form has been submitted to our heroku endpoint...');
      //
      //
      //   }
      // })
                  ...
                  <div className="grid1of2">
                    ...
                    <div className={(this.state.input4) ? "input-group invalid" : "input-group"}>
                      ...
                      <div className={(this.state.input4) ? "error-message mt-1 is-visible" : "error-message mt-1 is-hidden" }>
                        10 digit Phone number in the format ###-###-#### is required.
                      </div>
                    </div>
                  </div>
              </div>
