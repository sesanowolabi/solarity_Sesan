...
const HeadlineOverTwoCol = props => {
  const data = props.data;
  return (
    <section className="full-width stripe_2 " >
      <div className="container--lg inner_1 clearfix">
        ...
        <div className="grid">
          <div className="grid1of2">
            <div className="pb-1" dangerouslySetInnerHTML={{__html: data.richText.content}}></div>
          </div>
          <div className="grid1of2 text-center pl-2 pr-2 ">
            <div className="headshot-v2 borderradius--circle block " style={{backgroundImage: 'url('+ data.testimonialImage[0].url +')'}}></div>
            <p> &quot;{data.testimonialText}&quot;</p>
            <p className="italic"> - {data.testimonialAuthor}</p>
          </div>
...
export default HeadlineOverTwoCol;
